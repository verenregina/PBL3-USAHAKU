                    ...
                    <div class="form-section-box">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="lama_usaha" min="0" placeholder="Masukkan lama usaha"
                                    required>
                    ...
                    <div class="form-section-box">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="jumlah_karyawan" placeholder="Masukkan jumlah karyawan"
                                    required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="produksi_aktual" placeholder="Masukkan produksi aktual"
                                    required>
